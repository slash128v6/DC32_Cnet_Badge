...
int audioState = 0;
const int touchThresholdPlay = 20;
const int touchThresholdRwd = 20;
const int touchThresholdFwd = 20;
const int touchThresholdVdn = 20;
const int touchThresholdVup = 20;
const int touchThresholdMute = 20;
